...
export function DashboardExpenseBreakdownChart({
  ...
  description = "Where spend is concentrated across categories.",
  className,
  onCategoryClick,
    ...
    <Card className={cn("border-slate-200/80 bg-gradient-to-br from-white via-slate-50/80 to-slate-100/70 shadow-sm", className)}>
      <CardHeader className="space-y-2">
        ...
        <div className="text-sm text-slate-600">
          Total spend {formatCurrency(totalExpenses, defaultCurrency)}
        </div>
      </CardHeader>
              ...
              >
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-slate-500">{category.transactionCount} transactions</div>
                  </div>
                </div>
